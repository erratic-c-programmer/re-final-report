...
inoremap <C-Down> J
inoremap <C-Left> H
inoremap <S-Right> :vsplit
inoremap <S-Up> :splitk
inoremap <S-Down> :split
inoremap <S-Left> :vsplith
inoremap <Right> l
inoremap <Up> k
inoremap <Down> j
inoremap <Left> h
...
nnoremap <silent> <C-Space> :CtrlSpace
...
nnoremap <F2> :call codepainter#paintText('')
vnoremap <F2> :call codepainter#paintText(visualmode())
nnoremap <C-Right> L
nnoremap <C-Up> K
nnoremap <C-Down> J
nnoremap <C-Left> H
...
nnoremap <S-Up> :splitk
nnoremap <S-Down> :split
nnoremap <S-Left> :vsplith
nnoremap <Right> l
nnoremap <Up> k
nnoremap <Down> j
nnoremap <Left> h
...
set hidden
set mouse=a
set runtimepath=~/.config/coc/extensions/node_modules/coc-explorer,~/.config/nvim,~/.local/share/nvim/plugged/vim-argumentative,~/.local/share/nvim/plugged/vim-GAS-x86_64-highlighter,~/.local/share/nvim/plugged/goyo.vim,~/.local/share/nvim/plugged/vim-plug,~/.local/share/nvim/plugged/vimtex,~/.local/share/nvim/plugged/vim-codepainter,~/.local/share/nvim/plugged/undotree,~/.local/share/nvim/plugged/gruvbox,~/.local/share/nvim/plugged/coc.nvim,~/.local/share/nvim/plugged/vim-cpp-enhanced-highlight,~/.local/share/nvim/plugged/nerdcommenter,~/.local/share/nvim/plugged/Molokai,~/.local/share/nvim/plugged/vim-abolish,~/.local/share/nvim/plugged/vim-eunuch,~/.local/share/nvim/plugged/vim-fugitive,~/.local/share/nvim/plugged/haskell-vim,~/.local/share/nvim/plugged/vim-surround,~/.local/share/nvim/plugged/vim-airline,~/.local/share/nvim/plugged/vim-airline-themes,~/.local/share/nvim/plugged/vim-ctrlspace,~/.local/share/nvim/plugged/vim-windowswap,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/usr/share/nvim/runtime,/usr/share/nvim/runtime/pack/dist/opt/matchit,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,~/.local/share/nvim/plugged/vimtex/after,~/.local/share/nvim/plugged/vim-cpp-enhanced-highlight/after,~/.local/share/nvim/plugged/haskell-vim/after,/usr/share/vim/vimfiles
set scrolloff=1
set shada='20,<1000
set shiftwidth=2
