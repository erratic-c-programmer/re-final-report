...
\begin{multicols}{2}
  ...
  implemented would be a good idea, corroborating with \cref{ssect:gropt}. The one respondent that did not agree
  ...
  classroom cool naturally, agreeing with \cref{sec:grhelp}. He also mentioned that he did not know any
